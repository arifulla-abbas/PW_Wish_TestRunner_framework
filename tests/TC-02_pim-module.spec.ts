...
test('[PIM]Verify that a new employee is successfully created under the PIM module', { tag: ['@UI', '@UAT'], annotation: { type: 'Test Case Link', description: 'JIRA link: ORANGEHRM-1004' } }, async ({ gotoOrangeHRM, leftHandNavigationPage, pimPage }) => {
